...
const std::vector<Vertex> vertices = {{{-1.0f, -1.0f}, {1.0f, 0.0f, 0.0f}, {-1.0f, 1.0f}},  //Y coordinate is flipped!
...
private:
  ...
  void createPoolBuffers()
  {
    ...
    createBuffer(bufferSize, VK_BUFFER_USAGE_STORAGE_BUFFER_BIT,
                 VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, poolBuffer, poolBuffersMemory);
  }
  ...
  void createTextureImage()
  {
    ...
    createImage(texWidth, texHeight, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_SAMPLE_COUNT_1_BIT,
  ...
  void createColorResources()
  {
    ...
    createImage(swapChainExtent.width, swapChainExtent.height, colorFormat, VK_IMAGE_TILING_OPTIMAL, msaaSamples,
